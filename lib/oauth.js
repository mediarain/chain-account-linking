...
const DEFAULT_REDIRECT_DOMAINS = ['layla.amazon.com', 'pitangui.amazon.com'];
...
class OAuth {
  ...
  redirectURL(uuid, res) {
    const redirectDomains = _.get(this.link.chain.config, 'auth.redirectDomains', DEFAULT_REDIRECT_DOMAINS);
